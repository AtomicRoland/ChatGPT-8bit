\ WiFi driver for Atom ChatGPT client
...
.wifidriver
 ...
 jsr test_wifi_ena          \ test is wifi is enabled (in serial.asm)
...
.cwlap \ list access points
 ...
 \ x = 7 -> only show encryption type, ssid and signal strength
